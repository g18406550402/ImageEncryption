...
figure(1);imshow(P);
K=[1.1 2.2 3.3 4.4];
K1=K;K1(1)=K1(1)+10^(-13);K2=K;K2(1)=K2(1)+10^(-13);
K3=K;K3(1)=K3(1)+10^(-13);K4=K;K4(1)=K4(1)+10^(-12);
C1=TpEncrypt(P,K);
C2=TpEncrypt(P,K1);C3=TpEncrypt(P,K2);C4=TpEncrypt(P,K3);C5=TpEncrypt(P,K4);
...
DC1=abs(C1-C2);DC2=abs(C1-C3);DC3=abs(C1-C4);DC4=abs(C1-C5);
